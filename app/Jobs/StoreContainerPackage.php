...
class StoreContainerPackage implements ShouldQueue
{
    ...
    {
        // Add multi container package have container_id = container->id into database
        for ($i = 0; $i < count($this->request['style_noes']); $i++) {
            $this->container->packages()->create([
